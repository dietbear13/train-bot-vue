      ...
      <v-expand-transition>
        <v-card v-if="showInjuryFilters" class="pa-0 my-2 dark-background">
          ...
          <v-card-text class="px-1 pb-1 pt-0">
            ...
            <p class="ml-2">Фильтр по травмам сильно уменьшит число упражнений, из которых создаются программы тренировок. Ставьте, если острая фаза или прямые противопоказания.</p>
            <v-checkbox
