<!-- pages/nutrition/kbzhu-calculator.vue -->
<template>
  <div class="py-0">
    <!-- Выбор пола -->
...
import { useKbzhu } from '../../composables/useKbzhu';
import { useKbzhuAnalytics } from '../../composables/analytics/usersKbzhu';
import BottomSheetWithClose from '../../components/shared/BottomSheetWithClose.vue';
import KbzhuCalculatorTest from '../../components/nutrition/KbzhuCalculatorTest.vue';
